...
pub trait Downcast: Any {
    ...
    fn into_any_rc(self: ::alloc::rc::Rc<Self>) -> ::alloc::rc::Rc<dyn Any>;
...
pub trait DowncastSync: Downcast + Send + Sync {
    ...
    fn into_any_arc(self: ::alloc::sync::Arc<Self>) -> ::alloc::sync::Arc<dyn Any + Send + Sync>;
}
...
macro_rules! impl_downcast {
    ...
    (@impl_body $trait_:ident [$($types:tt)*]) => {
        ...
        ) -> ::core::result::Result<::alloc::boxed::Box<__T>, ::alloc::boxed::Box<Self>> {
            if self.is::<__T>() {
        ...
        ) -> ::core::result::Result<::alloc::rc::Rc<__T>, ::alloc::rc::Rc<Self>> {
            if self.is::<__T>() {
    ...
    (@impl_body_sync $trait_:ident [$($types:tt)*]) => {
        ...
        ) -> ::core::result::Result<::alloc::sync::Arc<__T>, ::alloc::sync::Arc<Self>>
            where __T: ::core::any::Any + ::core::marker::Send + ::core::marker::Sync
        {
            if self.is::<__T>() {
    ...
    macro_rules! test_mod {
            ...
            mod $test_mod_name {
                ...
                test_mod!(
                    ...
                    [{
                        ...
                        let arc: ::alloc::sync::Arc<$base_type> = ::alloc::sync::Arc::new(Foo(42));
        ...
        (
            ...
            fn $test_name() {
                ...
                fn get_val(base: &::alloc::boxed::Box<$base_type>) -> u32 {
                    match base.downcast_ref::<Foo>() {
                        Some(val) => val.0,
                        None => 0
                    }
                }
                fn set_val(base: &mut ::alloc::boxed::Box<$base_type>, val: u32) {
                    if let Some(foo) = base.downcast_mut::<Foo>() {
                        foo.0 = val;
                    }
                }

                let mut base: ::alloc::boxed::Box<$base_type> = ::alloc::boxed::Box::new(Foo(42));
                ...
                let rc: ::alloc::rc::Rc<$base_type> = ::alloc::rc::Rc::new(Foo(42));
